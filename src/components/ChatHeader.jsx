        ...
        <div className="py-4 px-6 sticky top-0 z-10">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3 flex-1">
                    ...
                    {/* Avatar and Info */}
                    {userExists && <div className="flex items-center gap-3 flex-1 min-w-0 group cursor-pointer"
                        ...
                        <div className="relative shrink-0">
                            ...
                            {/* Online Green Dot */}
                            {isConnectionOk && isOnline && (<div className="absolute bottom-0 right-0 w-3 h-3 bg-green-500 rounded-full"
                ...
                {/* Action Buttons */}
                {userExists && isConnectionOk && <div className="flex items-center gap-2">
