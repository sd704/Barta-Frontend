...
const ProfileHeaderButton = ({ variant = 'default', onClickAction, children }) => {
    ...
    return (
        <motion.button
            className={`px-6 py-2.5 rounded-xl cursor-pointer ${variant === 'default' ? 'bg-zinc-200 text-zinc-900 hover:text-orange-600' : 'bg-orange-600 text-white hover:bg-orange-500'}`}
