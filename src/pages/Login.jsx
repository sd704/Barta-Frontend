            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="w-full max-w-md">
                ...
                <div className="flex justify-center mb-8">
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <ModeSwitch isOn={isSignup} onToggle={() => setIsSignup(!isSignup)} />
                    </div>
                </div>
                        ...
                        <AnimatePresence mode="wait">
                            {isSignup && (
                                <motion.div key="name" initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }} transition={{ duration: 0.3 }}
                                    className="m-0">
                                    <LoginInputBox label="Name" type="text" value={name} onChange={setName} placeholder="Enter your name" />
                                </motion.div>
                            )}
                        </AnimatePresence>
                        ...
                        <div className="flex flex-row-reverse justify-between items-center px-4">
                            <div className="flex gap-2">
                                <div className="w-2 h-2 bg-zinc-200 rounded-full"
                                    style={{ boxShadow: "inset 2px 2px 4px rgba(0,0,0,0.15), inset -1px -1px 2px rgba(255,255,255,0.7)" }} />
                                <div className="w-2 h-2 bg-zinc-200 rounded-full"
                                    style={{ boxShadow: "inset 2px 2px 4px rgba(0,0,0,0.15), inset -1px -1px 2px rgba(255,255,255,0.7)" }} />
